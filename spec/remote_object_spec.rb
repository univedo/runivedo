...
describe Runivedo::RemoteObject do
  ...
  it 'sends instanciation' do
    ro
    stream.sent_data.should == [4, 42, 'appname', 'roname']
  end
  ...
  context 'rom calls' do
    it 'sends simple call' do
      ...
      ro.foo
      stream.sent_data.should == [1, 42, 0, 'foo']
    end
    ...
    it 'sends multiple calls' do
      ...
      ro.foo
      ro.bar
      stream.sent_data.should == [1, 42, 0, 'foo'] + [1, 42, 1, 'bar']
    end
    ...
    it 'sends parameters' do
      ...
      stream.sent_data.clear
      ro.foo('bar', 1)
      stream.sent_data.should == [1, 42, 0, 'foo', 'bar', 1]
    end
    ...
    it 'camelizes' do
      ...
      stream.sent_data.clear
      ro.foo_bar
      stream.sent_data.should == [1, 42, 0, 'fooBar']
    end
  end
end
